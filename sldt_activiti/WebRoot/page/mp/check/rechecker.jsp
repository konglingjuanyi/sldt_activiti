...
<script type="text/javascript" src="<%=request.getContextPath() %>/page/mp/check/rechecker.js"></script>
...
<div style="padding: 10px;">
	<div id="top" style="padding-bottom: 10px;">变更申请单复审</div>
		...
		<form id="checkForm" action="">
			<div id="btnDiv" align="center" style="margin: 10px;">
				<table class="msg_table">
					<tr>
						<td class="msg_table_odd2" style="height:20px;">审核结果</td>
						<td class="msg_table_even2"  style="text-align: left;">
							<div style="float: left;padding-left: 20px; height:30px;">
					...
					<tr>
						<td class="msg_table_odd2" style="height:20px;">审核意见</td>
