...
<script type="text/javascript" src="<%=request.getContextPath() %>/page/mp/check/feedbac.js"></script>
...
<div style="padding: 10px;">
	<div id="top" style="padding-bottom: 10px;">受影响方评估反馈</div>
		...
		<form id="checkForm" action="">
			<div id="btnDiv" align="center" style="margin: 0;">
				<table class="msg_table">
					<tr>
						<td class="msg_table_odd2" style="height:20px;">反馈意见</td>
