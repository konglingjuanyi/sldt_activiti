...
<script type="text/javascript" src="<%=request.getContextPath() %>/page/mp/check/appraisal.js"></script>
...
<div style="padding: 10px;">
	<div id="top" style="padding-bottom: 10px;">全行评审</div>
		...
		<form id="checkForm" action="">
			<div id="btnDiv" align="center" style="margin: 10px;">
				<table class="msg_table">
					<tr>
						<td class="msg_table_odd2" style="height:20px;">评审结果</td>
					...
					<tr>
						<td class="msg_table_odd2" style="height:20px;">评审意见</td>
