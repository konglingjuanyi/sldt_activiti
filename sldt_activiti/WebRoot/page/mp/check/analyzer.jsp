...
<script type="text/javascript" src="<%=request.getContextPath() %>/page/mp/check/analyzer.js"></script>
...
<LINK rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/page/mp/css/check/analyzer.css">
...
<div style="padding: 10px;">
	<div id="top" style="padding-bottom: 10px;">影响方分析</div>
	...
	<div id="handle">
		...
		<div id="tableDiv" style="margin: 10px;">
		...
		<form id="checkForm" action="">
			<div id="btnDiv" align="center" style="margin: 10px;">
				<table class="msg_table">
					<tr>
						<td class="msg_table_odd2" style="height:20px;">分析结果</td>
						<td class="msg_table_even2" style="text-align: left;height:30px;">
							<div style="float: left;padding-left: 20px;">
								<input name="checkResult" type="radio" value="1"/>有影响
							</div>
							<div style="padding-left: 80px;">
								<input name="checkResult" type="radio" value="0"/>无影响
							</div>
						</td>
					</tr>
					<tr id="listTr">
						<td class="msg_table_odd2" style="height:20px;">会签人</td>
						<td class="msg_table_even2" style="height:20px;text-align: left;">
							<input id="listInput" style="height:30px;width:610px; line-height: 30px;" type="text" readonly="readonly"/>
							<input id="listValInput" class="msg_input" type="text" readonly="readonly" style="display: none"/>
							<input id="choose" type="button" value="选择"/>
						</td>
					</tr>
					<tr>
						<td class="msg_table_odd2" style="height:20px;">意见</td>
