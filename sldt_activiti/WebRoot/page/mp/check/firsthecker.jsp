...
var decId = '<%=request.getAttribute("decId")%>';
...
<script type="text/javascript" src="<%=request.getContextPath() %>/page/mp/check/firsthecker.js"></script>
...
<div style="padding: 10px;">
	<div id="top" style="padding-bottom: 10px;">变更申请审核</div>
	<div id="top_color"><hr color="#ed1a2e"/></div>
	<div id="handle" style="height: 457px">
